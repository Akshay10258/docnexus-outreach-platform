...
const DEFAULT_STEPS: SequenceStep[] = [
    {
        ...
        bodyTemplate: `Dear Dr. {{doctor_name}},\n\nI hope this message finds you well. I'm reaching out because DocNexus works with leading {{specialty}} practitioners, and I believe there's an opportunity worth discussing with your team at {{affiliation}}.\n\nWould you be open to a brief 15-minute call this week?\n\nBest regards,\nDocNexus Team`,
    },
    {
        stepNumber: 2,
        delayDays: 3,
        subjectTemplate: "Following up — DocNexus for {{specialty}}",
        bodyTemplate: `Dear Dr. {{doctor_name}},\n\nI wanted to follow up on my previous message. I understand you're busy, so I'll keep this brief — we've been helping {{specialty}} teams at institutions like {{affiliation}} streamline their research workflows.\n\nWould a quick call work for you?\n\nBest regards,\nDocNexus Team`,
    },
];
...
export default function NewCampaignPage() {
    ...
    const handleSave = async (launch: boolean) => {
        ...
        const res = await fetch("/api/campaigns", {
            ...
            body: JSON.stringify({ name: name.trim(), type, enrolledPhysicianIds: [], sequences: steps }),
        });
